...
function calculaEdad () {
  ...
  if (edad>=16){
    document.getElementById("aviso1").innerHTML = "¡Genial, tienes "+edad+ " años, puedes acceder a todas las funcionalidades!"
    document.getElementById("aviso1")
  }
  else{
    document.getElementById("aviso1").innerHTML = "Lo sentimos, debes ser mayor para disfrutar de todas las funcionalidades";
    document.getElementById("aviso1")
  }
